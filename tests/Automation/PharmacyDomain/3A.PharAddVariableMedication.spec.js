  ...
  test("Add Medications", async ({ page }) => {
    ...
    await patientsearch.selectBornDate(data.pat_dob);
     ...
     // await page.pause()
      ...
      //  if(await Medications.checkItemOnHistoryTable(jsonData.AddMedication2[index].pacr_que_name)){
      //   //await Medications.clickOnItemReview(jsonData.AddMedication[index].pacr_que_name);
      //   //console.log("Item reviewed before deleting");
      //   await Medications.clickOnItemEdit(jsonData.AddMedication2[index].pacr_que_name);
      //   await page.waitForTimeout(1000)
      //   await MedicationsExtraDetails.clickOnDelete();
      //   await MedicationsExtraDetails.clickOnConfirmDelete();
      //   await MedicationsExtraDetails.enterDeleteReason('Deleted Existing item');
      ...
      await page.waitForTimeout(2000);            
      //await page.pause() 
      await MedicationsExtraDetails.clickOnMedicationDosingLink();
      await page.waitForTimeout(2000); 
      await MedicationsExtraDetails.clickOnAddVariableDosingLink();
      await page.waitForTimeout(2000);
      await MedicationsExtraDetails.EnterVariableDose0Input();
      await MedicationsExtraDetails.EnterVariableForm0Input();
      await MedicationsExtraDetails.SelectVariableRoute0Input();
      await MedicationsExtraDetails.SelectvariableFrequency0Input();
      await MedicationsExtraDetails.EnterVariableDuration0Input();
      await MedicationsExtraDetails.SelectVariableUnits0Input();
      await MedicationsExtraDetails.EnterVariableDosingInstructionTextarea()
      await MedicationsExtraDetails.clickOnSetButton();
      await page.pause()
